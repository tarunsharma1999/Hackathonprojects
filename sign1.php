...
<body bgcolor="#FFD4A7">
  ...
  <form class="modal-content animate" action="sign.php" method="post">
    <div class="container">
      ...
      <b>E-mail</b>
      <br><input type="text" placeholder="Enter Your Email" name="email" required  style="width: 100%;"><br>
      <b>Password</b>
      <br><input type="password" placeholder="Enter Password" name="password" required  style="width: 100%;"><br>
      <b>Confirm Password</b>
      <br><input type="password" placeholder="Re-enter password" name="Re-enter" required style="width: 100%;"><br>
      <b>DOB:</b>
      ...
      <div class="clearfix">
        <button type="button" onclick="document.getElementById('signup').style.display='none'" class="cancelbtn">Cancel</button>
         <button type="button" onclick="document.getElementById('mohit').style.display='none'" class="next">Next</button>
      </div>
    </div>
  </form>
